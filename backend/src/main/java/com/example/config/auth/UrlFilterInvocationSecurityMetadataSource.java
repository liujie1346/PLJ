...
//自定义UrlFilterInvocationSecurityMetadataSource实现FilterInvocationSecurityMetadataSource
// 重写getAttributes()方法
// *** 获取访问该url所需要的角色权限信息
@Component
...
//        // "/login"在WebSecurityConfig.java中已经放行
        ...
        for (RolePermission rp : rolePermissions) {
            System.out.println(requestUrl+"==="+rp.getResource_url()+"---"+requestUrl.equals(rp.getResource_url()));
